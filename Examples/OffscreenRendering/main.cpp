...
int main()
{
  ...
  swapchain->AddImageAttachment(0, description); // ћб она должна вернуть какой-то объект, который можно будет передать в другой Swapchain и тем самым св€зать два Swapchain'a
