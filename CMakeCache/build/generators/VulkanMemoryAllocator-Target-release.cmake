...
########## GLOBAL TARGET PROPERTIES Release ########################################
    set_property(TARGET GPUOpen::VulkanMemoryAllocator
                 APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    ...
    set_property(TARGET GPUOpen::VulkanMemoryAllocator
                 ...
                 $<$<CONFIG:Release>:${vulkan-memory-allocator_LINKER_FLAGS_RELEASE}>)
    set_property(TARGET GPUOpen::VulkanMemoryAllocator
                 APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${vulkan-memory-allocator_INCLUDE_DIRS_RELEASE}>)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET GPUOpen::VulkanMemoryAllocator
                 APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${vulkan-memory-allocator_LIB_DIRS_RELEASE}>)
    set_property(TARGET GPUOpen::VulkanMemoryAllocator
                 APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${vulkan-memory-allocator_COMPILE_DEFINITIONS_RELEASE}>)
    set_property(TARGET GPUOpen::VulkanMemoryAllocator
                 APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${vulkan-memory-allocator_COMPILE_OPTIONS_RELEASE}>)

########## For the modules (FindXXX)
set(vulkan-memory-allocator_LIBRARIES_RELEASE GPUOpen::VulkanMemoryAllocator)
