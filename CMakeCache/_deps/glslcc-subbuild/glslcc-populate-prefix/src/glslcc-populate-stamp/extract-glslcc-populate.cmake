...
#
get_filename_component(filename "C:/Users/rozhkov/Desktop/RHI/CMakeCache/_deps/glslcc-subbuild/glslcc-populate-prefix/src/glslcc-1.7.6-win64.zip" ABSOLUTE)
get_filename_component(directory "C:/Users/rozhkov/Desktop/RHI/CMakeCache/_deps/glslcc-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-glslcc-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-glslcc-populate${i}")
