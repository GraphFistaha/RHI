...
The goal of this project - simple graphic interface that keeps all modern features as multithreading, ray-tracing, compute shaders and so on.
Under the hood it can use different API's like vulkan or directX12, but you shouldn't think about it.
...
# Examples
Each example is a little test application which is checks some feature of API like uniforms, rendering geometry, multithreading and so on.  
